...
- Active monitoring in distributed Openshift systems.
- Continuous profiling using eBPF.

## 🌱 I'm Currently Learning / Focusing On

*   Deepening my understanding of **Go** for backend development and distributed systems.
*   Exploring practical applications of **Rust** for systems programming.
*   Contributing more to open source project around eBPF and continuous profiling.
